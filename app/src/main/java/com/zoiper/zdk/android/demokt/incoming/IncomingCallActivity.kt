...
class IncomingCallActivity : BaseActivity(), AccountEventsHandler, CallEventsHandler {
    ...
    private fun startActivity(activityClass: Class<out Activity>) {
        val intent = Intent(this@IncomingCallActivity, activityClass)
        ...
        this@IncomingCallActivity.startActivity(intent)
    }
    ...
    private fun onHangupButtonClicked() {
        ...
        incomingTvWaiting.visibility = View.VISIBLE
        incomingRlBase.visibility = View.GONE
